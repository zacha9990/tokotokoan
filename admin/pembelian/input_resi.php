...
<table class="table table-bordered">
	<tr>
		...
		<td width="50%">
			...
			<br>
			Nama : <i><?php echo $datapembelian ['nama_penerima'] ?> - <?php echo $datapembelian ['telp_penerima'] ?></i>
			<br>
			Alamat : <i><?php  echo $datapembelian ['alamat_penerima'] ?> - <?php echo $datapembelian ['kode_pos'] ?></i>
			<br>
			Kota/Kabupaten : <i><?php echo $datapembelian['kota'] ?></i>
			<br>
...
<table class="table table-bordered">
	<tr>
		...
		<td>
				<span class="label label-warning"><?php echo $datapembelian['status_pembelian'] ?></span>
		</td>
	</tr>
	<tr>
